...
import getAnswerFromChatGPT from '@salesforce/apex/CustomerChatGPTIntegration.getAnswerFromChatGPT';
import MY_STATIC_RESOURCE from '@salesforce/resourceUrl/Chatbot';
import MY_Chat from '@salesforce/resourceUrl/ChatIcon';
//import apexcharts from '@salesforce/resourceUrl/ChartJs';
import summerizeCase from '@salesforce/apex/CustomerChatGPTIntegration.summerizeCase';
import accountDetails from '@salesforce/apex/CustomerChatGPTIntegration.accountDetails';
import CHATBOT_SPINNER from "@salesforce/resourceUrl/ChatBotSpinner";
import LOGO_URL from '@salesforce/resourceUrl/ChatBotLogo';

export default class CustomerUserInterface extends LightningElement {
    @track isOpen = false;
 
    //@api comment;
    chatbotLogoUrl = MY_STATIC_RESOURCE;
    chatUrl=MY_Chat;
    @track question = '';
    @track answer = '';
    @track typedMessage = [];
